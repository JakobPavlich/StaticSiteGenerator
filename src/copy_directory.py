...
def copy_directory(source_path: str = None, destination_path: str = None):
    # cwd = os.getcwd()
    ...
    for item in static_dir:
        ...
        if os.path.isfile(item_path):
            ...
            dir = item
            # print(f"-Looking at the directory: {dir}")
            # os.mkdir(os.path.normpath(os.path.join(destination_path, dir)))
            new_source_path = os.path.normpath(os.path.join(source_path, dir))
            new_destination_path = os.path.normpath(
                os.path.join(destination_path, dir))
            copy_directory(new_source_path, new_destination_path)
